        <?php
            $title = "About Us | Rent N' Run";
            $description = "about Rent N' Run";
        ...
        <section id="aboutSection">
            ...
            <section>
                ...
                <p>From the latest releases to timeless classics, our library of games is continuing to grow every day to help suit every taste and platform.</p>
            </section>
            <section>
                <h2>Founded in 20XX</h2>
